...
async function getEatingPlan(value) {
    ...
    for (let i = 0; i < breakfast.length; i++) {
        document.getElementById("breakfastOptions").innerHTML += `<div class="text-light blue rounded-left rounded-right border"> <p> ${breakfast[i].meal} </p> <img src="${breakfast[i].img}"></div>`
